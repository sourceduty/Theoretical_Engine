...
| Throughput Efficiency (kW)   | 760 kW                               | 461 kW                                   | 912 kW (20% improvement)                            | 553.2 kW (20% improvement)                              | 988 kW (30% improvement)                              | 599.3 kW (30% improvement)                              |

The integration of Self-Excited Stator (SES) technology into Tesla’s Model S Plaid and Model 3 Performance significantly improves their efficiency, as demonstrated by the increase in throughput after SES adoption. Before the SES system, both models were optimized for high performance, with the Model S Plaid delivering 760 kW and the Model 3 Performance producing 461 kW. After SES integration, the throughput increases due to the enhanced energy recovery, with improvements of 20% and 30% in energy efficiency. For the Model S Plaid, throughput increases from 760 kW to 912 kW with a 20% improvement and to 988 kW with a 30% improvement. Similarly, the Model 3 Performance experiences a throughput boost from 461 kW to 553.2 kW with a 20% efficiency increase and to 599.3 kW with a 30% improvement. This efficiency boost is attributed to SES technology’s ability to regenerate energy from the motor's motion, leading to less energy waste and improved power output for the same energy consumption. The torque and peak power values remain unchanged, highlighting that the improved throughput does not come at the expense of performance. This means that while both vehicles maintain their impressive acceleration and speed, they also become significantly more energy-efficient, extending their range and reducing energy consumption during prolonged drives. These improvements align with the increasing demand for sustainable, high-performance vehicles, making the Tesla Model S Plaid and Model 3 Performance not only faster but also more energy-conscious and suited for long-term, eco-friendly driving.
